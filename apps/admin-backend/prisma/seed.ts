  ...
  const products = [
    {
      ...
      title: "ChatGPT Plus - 1 Ð¼ÐµÑÑÑ†",
      titleEn: "ChatGPT Plus - 1 month",
      description: "ÐœÐ³Ð½Ð¾Ð²ÐµÐ½Ð½Ð°Ñ Ð°ÐºÑ‚Ð¸Ð²Ð°Ñ†Ð¸Ñ ChatGPT Plus Ð½Ð° 1 Ð¼ÐµÑÑÑ†",
    ...
    },
    {
      ...
      title: "ChatGPT Plus - 12 Ð¼ÐµÑÑÑ†ÐµÐ²",
      titleEn: "ChatGPT Plus - 12 months",
      description: "Ð”Ð¾Ð»Ð³Ð¾ÑÑ€Ð¾Ñ‡Ð½Ñ‹Ð¹ Ð¿Ð°ÐºÐµÑ‚ ÑÐ¾ ÑÐºÐ¸Ð´ÐºÐ¾Ð¹",
    ...
    {
      slug: "vpn_year",
      title: "VPN 12 ìåñÿöåâ",
      titleEn: "VPN 12 months",
      description: "Ñðîê: 365 äíåé",
