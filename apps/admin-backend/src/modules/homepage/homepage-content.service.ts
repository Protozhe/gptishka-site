    ...
    ru: [
      {
        ...
        isActive: true,
        badge: "",
        titleLines: ["ChatGPT vs Claude", "На чьей ты стороне?"],
        description: "Выбери своего фаворита в мире искусственного интеллекта.",
        buttonText: "",
        buttonHref: "",
        imageUrl: "",
        themeClass: "home-promo-slide--ai-battle",
        sortOrder: 1,
      },
      {
        id: "perplexity",
        isActive: true,
        badge: "Новинка",
        titleLines: ["Perplexity Pro", "теперь в GPTishka"],
        description: "AI-поиск с ответами по источникам, глубокие исследования и работа с файлами. Подписка Pro на 1 месяц — 1 999 ₽.",
        buttonText: "Открыть тариф",
        buttonHref: "/perplexity",
        imageUrl: "",
        themeClass: "home-promo-slide--perplexity",
        sortOrder: 5,
      },
      {
        id: "supergrok",
    ...
    en: [
      {
        ...
        isActive: true,
        badge: "",
        titleLines: ["ChatGPT vs Claude", "Whose side are you on?"],
        description: "Choose your favorite and see which AI is leading right now.",
        buttonText: "",
        buttonHref: "",
        imageUrl: "",
        themeClass: "home-promo-slide--ai-battle",
      ...
      },
      {
        ...
        isActive: true,
        badge: "New",
        titleLines: ["Perplexity Pro", "now at GPTishka"],
        description: "AI search with cited sources, deep research, and file analysis. One month of Perplexity Pro for 1,999 RUB.",
