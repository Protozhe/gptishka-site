...
(() => {
  ...
  function repairHeaderText() {
    ...
    const labels = en ? ["News", "App", "VK", "Telegram"] : ["Новости", "Приложение", "VK", "Telegram"];
