    ...
    return (
      ...
      ' data-badge="">' +
        '<div class="chatgpt-order-scroll">' +
          ...
          '<section class="chatgpt-order-section"><div class="chatgpt-order-section__head"><h4 class="chatgpt-order-section-title">Оплата</h4><p>Выберите платёжный шлюз</p></div><div class="chatgpt-order-payment chatgpt-payment-options" role="radiogroup" aria-label="Способ оплаты">' + renderChatGptPaymentOption("lava", "LAVA", "СБП 0% и карты 3.2%", "/assets/img/payment-lava.svg?v=20260724-lava-mark2", savedPaymentMethod) + renderChatGptPaymentOption("enot", "ENOT", "Карты 3.2% и СБП 0%", "/assets/img/payment-enot.svg", savedPaymentMethod) + '</div><p class="chatgpt-order-error" data-chatgpt-go-error-for="paymentMethod"></p><details class="chatgpt-order-collapsible chatgpt-order-processing-details"><summary>Сроки выполнения заказа</summary><p>Мы обрабатываем заказы ежедневно с 10:00 до 20:00 по МСК. Среднее время ожидания — от 5 минут до 2 часов после оплаты. Если заказ оформлен ночью — подключим с утра. Максимальное время выполнения — 2 рабочих дня.</p></details></section>' +
...
(() => {
  ...
  const SUPPORT_URL = "https://t.me/aiiisupport";
