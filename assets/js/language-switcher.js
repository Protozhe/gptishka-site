(() => {
  ...
  const ENGLISH_PRODUCT_ROUTES = new Map([
    ...
    ["/midjourney", "/en/midjourney.html"],
    ["/midjourney.html", "/en/midjourney.html"],
  ...
  const RUSSIAN_PRODUCT_ROUTES = new Map([
    ...
    ["/en/suno", "/suno"],
    ["/en/suno.html", "/suno"],
    ["/en/midjourney", "/midjourney"],
    ["/en/midjourney.html", "/midjourney"],
    ["/en/itunes", "/itunes"],
  ...
  function enhanceHeaderNavigation() {
    document.querySelectorAll("header").forEach((header) => {
      header.classList.add("gptishka-canonical-header");
    });
