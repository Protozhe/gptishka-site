(() => {
  const SCRIPT_VERSION = "20260724-header-layout1";
  const HEADER_CSS = "/assets/css/gptishka-header-refresh.css?v=20260724-language-slider1";
  const HEADER_NAV_CSS = "/assets/css/header-navigation-state.css?v=20260724-header-layout1";
      ...
      <div class="nav nav-shell">
        ...
        <nav class="header-quick-links" aria-label="${en ? "GPTishka quick links" : "Быстрые разделы GPTishka"}">
          ...
          <a class="header-quick-link header-social-link header-social-link--telegram" href="${TELEGRAM_URL}" target="_blank" rel="noopener" aria-label="${en ? "GPTishka on Telegram" : "GPTishka в Telegram"}">
            <svg class="header-social-icon header-social-icon--telegram" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M23.91 3.79 20.3 20.84c-.27 1.2-.98 1.49-1.99.93l-5.5-4.06-2.65 2.55c-.29.29-.54.54-1.1.54l.39-5.6 10.2-9.21c.44-.39-.1-.61-.68-.22L6.36 13.7.92 12c-1.18-.37-1.2-1.18.25-1.75L22.44 2.06c.98-.36 1.84.24 1.47 1.73Z"></path></svg>
          </a>
        </nav>
