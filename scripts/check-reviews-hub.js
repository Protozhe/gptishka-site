...
assert.match(client, /function prepareReviewDates/);
assert.match(client, /Math\.floor\(genericIndex \/ 4\)/);
assert.match(client, /isGenericMonthLabel\(item\.dateLabel\) \? "недавно"/);
...
assert.match(html, /reviews-hub\.js\?v=20260912-dated-trustfeed1/);
