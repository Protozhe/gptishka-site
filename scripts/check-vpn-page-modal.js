...
expect("VPN page has dark-blue video hero", vpnHtml.includes("service-hero--vpn") && vpnHtml.includes("service-hero__blue-overlay") && vpnHtml.includes("/assets/video/chatgpt-plans-bg.mp4"));
...
expect("VPN page loads cache-busted shared CSS/JS", vpnHtml.includes("/assets/css/home-stability-hotfix.css?v=20260619-vpn-service1") && vpnHtml.includes("/assets/js/app.min.js?v=20260620-vpn-card2"));
...
expect("app.js renders VPN directory card with real fallback images", appJs.includes('vpn: {') && appJs.includes('imageUrl: "/assets/img/services/vpn-card.png?v=20260620-vpn-card2"') && appJs.includes('hoverImageUrl: "/assets/img/services/vpn-card-hover.png?v=20260620-vpn-card2"'));
...
expect("app.min.js contains VPN service modal support", appMin.includes("GPTishka VPN") && appMin.includes("/store/vpn") && appMin.includes("vpn-card.png?v=20260619-vpn-service1"));
expect("app.min.js contains VPN directory fallback images", appMin.includes("vpn-card.png?v=20260620-vpn-card2") && appMin.includes("vpn-card-hover.png?v=20260620-vpn-card2"));
