...
expect("VPN page loads cache-busted shared CSS/JS", vpnHtml.includes("/assets/css/home-stability-hotfix.css?v=20260722-dark-checkout1") && vpnHtml.includes("/assets/js/app.min.js?v=20260722-claude-max-plans1"));
