...
for (const file of htmlFiles) {
  ...
  for (const match of html.matchAll(sharedAssetPattern)) {
    const expectedVersion = match[1] === "app.min.js"
      ...
      : new Set(["20260912-chat-restoration2", "20260912-restored-products1", "20260912-codex-entry-visual1", "20260913-viewport-fill1", "20260916-codex-header-price1", "20260917-readable-guide1"]);
